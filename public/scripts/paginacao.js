...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Mostrar _MENU_",sZeroRecords:"Nenhum registro encontrado",sInfo:"Mostrando _START_ à _END_ de _TOTAL_ registro(s)",sInfoEmpty:"Mostrando 0 à 0 de 0 registro",sInfoFiltered:"",sInfoPostFix:"",sSearch:"Filtro:",sUrl:"",oPaginate:{sFirst:"|< primeiro",sPrevious:"<< anterior",sNext:"próximo >>",sLast:"último >|"}};
...
var sStdMenu='<select size="1" '+sName+'><option value="5">05</option><option value="10">10</option><option value="25">25</option><option value="50">50</option><option value="100">100</option></select>';
