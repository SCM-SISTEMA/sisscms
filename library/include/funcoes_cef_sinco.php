...
//Guarda inicial
?><img src=<?=Zend_Registry::get('config')->caminho->componente.'/imagens/p.png'?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=<?=Zend_Registry::get('config')->caminho->componente.'/imagens/b.png'?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=<?=Zend_Registry::get('config')->caminho->componente.'/imagens/p.png'?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=<?=Zend_Registry::get('config')->caminho->componente.'/imagens/b.png'?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
<?php
$texto = $valor ;
if((strlen($texto) % 2) <> 0){
...
// Draw guarda final
?>
src=<?=Zend_Registry::get('config')->caminho->componente.'/imagens/p.png'?> width=<?php echo $largo?> height=<?php echo $altura?> border=0><img
src=<?=Zend_Registry::get('config')->caminho->componente.'/imagens/b.png'?> width=<?php echo $fino?> height=<?php echo $altura?> border=0><img
src=<?=Zend_Registry::get('config')->caminho->componente.'/imagens/p.png'?> width=<?php echo 1?> height=<?php echo $altura?> border=0>
  <?php
} //Fim da fun��o
