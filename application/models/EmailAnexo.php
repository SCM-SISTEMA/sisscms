<?php
	class Model_EmailAnexo extends Model_Db {
		private static $_instance = null;
		protected $_schema = 'sisscm';
		protected $_name = 'rl_email_anexo';
		
		/**
		 * Instância da classe Model_EmailAnexo
		 *
		 * @return Model_EmailAnexo
		 */
		public static function getInstance() {
			if(self::$_instance == null) {
				self::$_instance = new Model_EmailAnexo();
			}
