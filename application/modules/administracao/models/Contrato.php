...
class Administracao_Model_Contrato extends Administracao_Model_Db
{
	...
	public function getConsultaAll($arrParam) {
		...
		->joinLeft('tb_plano', 'tb_plano.co_plano = '.$this->_name.'.co_plano', array('ds_plano'), $this->_schema)
	...
	public function getConsulta($arrParam) {
		$sql = $this->getAdapter()->select()->from($this->_name,array('*'),$this->_schema)
				->joinLeft('tb_pessoa_juridica', 'tb_pessoa_juridica.co_pessoa_juridica = '.$this->_name.'.co_pessoa_juridica', array('no_razao_social', 'ds_endereco as ds_endereco_pj','nu_endereco as nu_endereco_pj', 'no_bairro as no_bairro_pj', 'no_cidade as no_cidade_pj', 'sg_uf as sg_uf_pj', 'nu_cep as nu_cep_pj', 'nu_telefone_1'), $this->_schema)
				->joinLeft('tb_pessoa_fisica', 'tb_pessoa_fisica.co_pessoa_fisica= '.$this->_name.'.co_pessoa_fisica', array('no_pessoa_fisica', 'ds_endereco as ds_endereco_pf', 'nu_endereco as nu_endereco_pf', 'no_bairro as no_bairro_pf', 'no_cidade as no_cidade_pf', 'sg_uf as sg_uf_pf', 'nu_cep as nu_cep_pf', 'nu_telefone_1'), $this->_schema)
				->joinLeft('tb_plano', 'tb_plano.co_plano = '.$this->_name.'.co_plano', array('ds_plano'), $this->_schema)
