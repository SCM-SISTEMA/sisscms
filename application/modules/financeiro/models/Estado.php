...
class Administracao_Model_Estado extends Administracao_Model_Db
{
	...
	/**
	 * Instância da classe Administracao_Model_Estado
	 *
	 * @return Administracao_Model_Estados
	 */
	public static function getInstance() {
		if(self::$_instance == null) {
			self::$_instance = new Administracao_Model_Estado();
		}
