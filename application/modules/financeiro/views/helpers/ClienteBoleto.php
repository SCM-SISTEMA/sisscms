<?php
class Zend_View_Helper_ClienteBoleto extends Zend_View_Helper_Abstract {
	public function clienteboleto($id='',$strParam='',$arrParam=array()) {
		$arrClientes = Administracao_Model_PessoaJuridica::getInstance()->getConsultaAll(array());

		echo "<select name='co_pessoa' id='co_pessoa_boleto' " . $strParam . ">";
