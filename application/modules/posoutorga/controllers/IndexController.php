...
class Posoutorga_IndexController extends Zend_Controller_Action
{
	...
	public function indexAction()
    {
    	...
    	if( $this->getRequest()->isPost()){
    		...
    		$this->_redirect('/administracao/acompanhamento/index/co_contrato/'.$this->getRequest()->getParam('co_contrato').'/msg/success' );
    		
    	}
    	
    	$this->view->empresa 				= Model_Checklist::getInstance()->getConsultaAll(array('co_fase' => 1));
    	$this->view->fase1 					= Model_Checklist::getInstance()->getConsultaAll(array('co_fase' => 2));
    	$this->view->fase2 					= Model_Checklist::getInstance()->getConsultaAll(array('co_fase' => 3));
    	$this->view->fase3 					= Model_Checklist::getInstance()->getConsultaAll(array('co_fase' => 4));
    	$this->view->ultimafase 			= Model_Checklist::getInstance()->getConsultaAll(array('co_fase' => 5));
