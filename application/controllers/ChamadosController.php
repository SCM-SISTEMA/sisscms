<?php
	class ChamadosController extends Zend_Controller_Action {
		public function indexAction()
	    {
	    	$data = date('Y-m-d H:i:s',strtotime('-72 hours'));
	    	$this->view->data = $data;
	    	$vencidos = Model_Chamado::getInstance()->getSlaVencido(array('data' => $data));
	    	if( count( $vencidos ) ){
	    		$this->view->vencidos = count( $vencidos );
	    	}
