<?php
	class GravacoesController extends Zend_Controller_Action {
		public function indexAction()
	    {
	    	...
	    	$gravacoes = Model_gravacoes::getInstance()->getConsultaAll( $arrParam );
	    	
	    	$page = $this->_getParam('page', 1);
	    	$pcount = $this->_getParam('count_per_page', 20);
	    	
	    	$paginator = Zend_Paginator::factory($gravacoes);
