<?php
	class ProvedorController extends Zend_Controller_Action {
		public function indexAction()
	    {
	    	...
	    	$provedores = Model_Provedor::getInstance()->getConsultaAll( $arrParam );
	    	
	    	$page = $this->_getParam('page', 1);
	    	$pcount = $this->_getParam('count_per_page', 20);
	    	
	    	$paginator = Zend_Paginator::factory($provedores);
